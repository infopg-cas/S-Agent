...
if __name__ == "__main__":
    ...
    prompt = "You are a math teach agent, you job is to solve the problem for the user. " \
             ...
             "2. You have to process only one step each time.\n" \
             "3. If you cannot process it, use the Finish step, and write 'Can't Help'." \
             "4. If there is no tools for you to choose, give the answer by yourself." \
             "5. Do not call actions that not defined in the tool library." \
             "Some examples are:\n" \
